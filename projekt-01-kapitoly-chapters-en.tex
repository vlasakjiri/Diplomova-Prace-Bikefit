...
\begin{figure}
    ...
    \caption{Loss of the RTMPose models during fine-tuning on the bikefitting dataset. The models were trained for 130 iterations, which corresponds to 1 epoch on the bikefitting dataset. The models were trained with the AdamW optimizer with base learning rate of 5e-4 and batch size of 16. The models were trained on an Intel i7-7500U CPU.}
