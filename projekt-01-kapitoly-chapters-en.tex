...
\begin{figure}[htbp]
    ...
    \caption{Example of the failed localization of the markers. The leaves in the background have similar color to the markers and the markers are therefore not localized correctly.}
