...
\begin{figure}[htbp]
    ...
    \caption{Placement of the markers used by Retül. (Screenshot from instructional \href{https://youtu.be/k-FsejpibKE?si=MxGCyxb2Jn7vXVaj}{instructional video} by Retül.)}
...
\begin{figure}[htbp]
    ...
    \caption{Retül's software showing the captured data. (Screenshot from  \href{https://youtu.be/hZgI87DUUbU?si=E3C55SrHN9Lan0bT}{instructional video} by Retül.)}
    \label{fig:retul_app}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Side view image with predicted keypoints in BikeFast Fit Elite. (Screenshot from  \href{https://youtu.be/4xhFhvIM7R4?si=S4a8ghVu8foHFj2s}{promotional video} by BikeFast Fit Elite.)}
...
The models are ran using the MMPose framework, with the Inferencer API and the PyTorch backend. Topdown models (models that output the pose results on cropped person images) use the RTMDet-nano model for person detection.
